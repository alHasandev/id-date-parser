const IndonesianDateParser = require('./parser-indonesia.js');
...
const examples = {
  ...
  combo: ['bsk smp lusa', '3 hr sblm Natal', 'mgg depn - mgg llu', 'dlm 2 bln lg', 'tgl 17 agst', 'kmrn lusa dr skrg', 'awl thn dpann', 'akhr mnggu ini'],
